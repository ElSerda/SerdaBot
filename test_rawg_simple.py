#!/usr/bin/env python3
"""
Test simple RAWG - Mode kiff 🎮

Test rapide de l'API RAWG sans complexité.
"""
import asyncio
import sys
import os
...
async def main():
    """Test des jeux populaires."""
    jeux = ["Hades", "Elden Ring", "Baldur's Gate 3"]
    
    print("\n" + "="*60)
    print("🎮 TEST RAWG API - Mode Kiff")
    print("="*60)
    
    for jeu in jeux:
        await test_rawg(jeu)
        await asyncio.sleep(0.5)  # Pas spam l'API
